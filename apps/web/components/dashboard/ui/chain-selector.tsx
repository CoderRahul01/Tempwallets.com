...
import { isGaslessSupportedChain } from '@/lib/chains';
  ...
  const allChains = useMemo(() => {
    ...
    return walletConfig.getMainnet()
      .filter((config) => {
        ...
        // STRICT FILTER: Only show chains supported by both Pimlico and Yellow (Base, Arbitrum)
        // This overrides all other visibility flags for the "Reset" requirement.
        if (!isGaslessSupportedChain(config.id)) {
          return false;
        }
